        ...
        <div class="wthree_pvtits-services align-w3" id="services">
            <div class="container">
                <div class="wthree_pvt_title text-center">
                    <h3 class="w3_head">Teknik Servis Hizmetlerimiz
                    </h3>
                    <p class="main_p mb-5  text-center mx-auto">
                        Mağazamızdan satın almış olduğunuz ürünlerde herhangi bir teknik problem oluşursa 2 yıl garantili teknik servis hizmetimizden faydalanabilirsiniz.
                    </p>
                    <a class="btn btn-primary" href="WebForm1.aspx" role="button">Arızalı Ürün Takibi</a>
                </div>
            ...
            <div class="contact_grid_right mt-5 mx-auto text-center">
                <form action="#" method="post" runat="server">
                    <div class="row contact_top">
                        <div class="col-sm-6">
                            <asp:TextBox ID="TextBox1" runat="server" placeholder="Adınız ve Soyadınız" required=""></asp:TextBox>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <asp:TextBox ID="TextBox4" runat="server" placeholder="Mesajınız" required="" TextMode="MultiLine" Height="50"></asp:TextBox>
